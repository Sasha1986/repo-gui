...
# Подсказка: попробуйте решить задачу двумя способами. Первый — возведение в степень с помощью оператора **.
    # Второй — более сложная реализация без оператора **, предусматривающая использование цикла.
        ...
        print("Задание: Реализовать функцию int_func(), принимающую слово из маленьких латинских букв\n"
        ...
        def int_func(word):
            """функция int_func(), принимающая слово из маленьких латинских букв и возвращающая его же,
            но с прописной первой буквой. Например, print(int_func(‘text’)) -> Text."""
            return word.title()
        print(int_func('text'))
        string = input("Введите строку из слов, разделенных пробелом,\n "
                       "каждое слово должно быть латинскими буквами в нижнем регистре: ").split()
        string_new = str()
        for item in string:
            string_new = string_new + " " + int_func(item)
        print(string_new)
    else:
